...
//	    }
	    ...
	    Email from = new Email("sengoutam6890@gmail.com");  
	...
	private String buildAdminEmailMessage(BookAppointment appointment) {
	    ...
	    String confirmUrl = "http://localhost:8080/appointments/" + appointment.getId() + "/confirm";
	    String cancelUrl  = "http://localhost:8080/appointments/" + appointment.getId() + "/cancel";
